...
- Your mission is to use Bootstrap and any CSS animations to create a compelling and interesting personal home page.
...
- Try yourself to create a single div on CodePen that is shown only when the screen is between 700 and 900 pixels wide.
